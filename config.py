...
MODEL_LIST = [
    ...
    # [ABS_PATH + "/Model/b/G_402000_model.pth", ABS_PATH + "/Model/b/G_402000_config.json"],
    [ABS_PATH + "/Model/g/G_YS_953000_model.pth",
        ABS_PATH + "/Model/g/G_YS_953000_config.json"],
